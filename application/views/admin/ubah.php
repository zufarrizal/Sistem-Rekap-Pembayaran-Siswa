            ...
            <div class="col-lg-6">
                <div class="box">
                    ...
                    <form role="form" method="POST" action="">
                        <div class="box-body">
                            <input type="hidden" class="form-control" id="id" name="id" value="<?= $users['id_user'] ?>">
                            <div class="form-group">
                                <label for="username">Nama Pengguna</label><small class="text-danger"><?= form_error('username'); ?></small>
                                <input type="text" class="form-control" id="username" name="username" placeholder="Nama Pengguna" value="<?= $users['username'] ?>">
                            </div>
                            <div class=" form-group">
