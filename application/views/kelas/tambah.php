                    ...
                    <form role="form" method="POST" action="">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nkelas" name="nkelas" placeholder="Nama Kelas">
                            </div>
                            <div class="form-group">
                                <label for="sub">Sub Kelas</label><small class="text-danger"><?= form_error('sub'); ?></small>
                                <input type="text" class="form-control" id="sub" name="sub" placeholder="sub Kelas">
                            </div>
                        </div>
                        <!-- /.box-body -->
